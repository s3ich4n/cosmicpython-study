...
from pt2.ch11.src.allocation.domain import events, commands
from pt2.ch11.src.allocation.service_layer import handlers
...
class MessageBus:
    EVENT_HANDLERS = {
        events.Allocated: [handlers.publish_allocate_event],
