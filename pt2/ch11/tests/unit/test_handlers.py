...
from pt2.ch11.src.allocation.domain import model, events, commands
from pt2.ch11.src.allocation.service_layer import unit_of_work, handlers, messagebus
from pt2.ch11.src.allocation.adapters import repository
from pt2.ch11.src.allocation.service_layer.messagebus import Message
from pt2.ch11.tests.e2e.conftest import random_batchref
...
class FakeUnitOfWork(unit_of_work.AbstractUnitOfWork):
    def __init__(self):
        ...
        self.messages_published: List[events.Event] = []
...
class TestChangeBatchQuantity:
    ...
    async def test_reallocates_if_necessary(self):
        ...
        [reallocation_event] = [
            x for x in uow.messages_published
            if isinstance(x, commands.Allocate)
        ]
