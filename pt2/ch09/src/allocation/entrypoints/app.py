...
from pt2.ch09.config import Settings
from pt2.ch09.container import Container

from pt2.ch09.src.allocation.domain import model, events
from pt2.ch09.src.allocation.entrypoints import BatchRequest, OrderLineRequest
from pt2.ch09.src.allocation.service_layer import unit_of_work, messagebus, handlers
