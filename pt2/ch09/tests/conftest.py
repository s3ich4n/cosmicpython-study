...
from pt2.ch09.src.allocation.adapters.orm import start_mappers
from pt2.ch09.src.allocation.adapters.postgres import AsyncSQLAlchemy
...
async def test_client() -> AsyncClient:
    from pt2.ch09.src.allocation.entrypoints.app import app
